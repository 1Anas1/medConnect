...
router.post('/session/:appointmentId/signal', videoController.handleWebRTCSignal);

// Poll for WebRTC signals intended for the user
router.get('/session/:appointmentId/signal', videoController.pollSignals);
